...
var ControllerPlats = /** @class */ (function () {
    ...
    ControllerPlats.getAllPlats = function (req, res) {
    ...
    ControllerPlats.getOnePlat = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var platId, platDetail;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        platId = req.params.id;
                        return [4 /*yield*/, plats_1.Plat.getOnePlat(platId)];
                    case 1:
                        platDetail = _a.sent();
                        res.send(platDetail);
                        return [2 /*return*/];
    ...
    ControllerPlats.getPlatsFromType = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var platType, listePlats;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        platType = req.params.type;
                        return [4 /*yield*/, plats_1.Plat.getPlatsFromType(platType)];
                    case 1:
                        listePlats = _a.sent();
                        res.send(listePlats);
                        return [2 /*return*/];
    ...
    ControllerPlats.removePlat = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var platId;
            return __generator(this, function (_a) {
                switch (_a.label) {
