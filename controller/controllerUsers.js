...
exports.ControllerUsers = void 0;
...
var ControllerUsers = /** @class */ (function () {
    ...
    ControllerUsers.signup = function (req, res, next) {
    ...
    ControllerUsers.login = function (req, res, next) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, users_1.User.getUser(req.body.mail).then(function (user) {
                            if (user === null) {
...
exports.ControllerUsers = ControllerUsers;
//# sourceMappingURL=controllerUsers.js.map